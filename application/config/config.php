...
|
*/
$config['base_url'] = 'http://localhost/model/';
...
|
*/
$config['encryption_key'] =  'p~dCld0*dkV)Z83$lqbt^3Ldie-=.nep';
...
$config['sess_save_path'] =  'C:\Program Files (x86)\Zend\Apache2\htdocs\model\ci_sessions'; //'/var/www/html/model/ci_sessions/';
