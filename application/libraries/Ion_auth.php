...
class Ion_auth
{
	...
	public function is_group_admin($id=false)
	{
		...
		$group_admin_group = $this->config->item('group_admin_group', 'ion_auth');

		return $this->in_group($group_admin_group, $id);
	}
	...
	public function is_guest($id=false)
	{
		...
		$guest_group = $this->config->item('guest_group', 'ion_auth');

		return $this->in_group($guest_group, $id);
	}
