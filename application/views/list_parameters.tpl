 ...
 * @copyright  2015
 * @version 0.5
 * @abstract  This generates the page thas lists all the parameters in the working project.
 */	
?>*}
        ...
        <tbody>
            {foreach $data as $row}
                <tr>
                    ...
                    <td>
                        {if !$guest}
                            <a href="index.php/parameters/edit/{$row.id}"><img src="stylesheets/images/edit.png" alt="Edit Record" /></a>
                            <a href="index.php/parameters/delete/{$row.id}"onclick="return confirm('You Are About to Delete a Record.  This Cannot be Undone.');"><img src="stylesheets/images/delete.png" alt="Delete record" /></a>
                        {/if}
                    </td>
                </tr>
            {/foreach}
