 ...
 * @copyright  2015
 * @version 0.5
 * @abstract  This generates the page for editing parameters.
 */	
?>*}
...
<div class="form-horizontal">
    <div class="form-group">
        ...
        <div class="col-md-10">
    	       <input class="form-control" id="focusedInput" placeholder="Enter Parameter Name" type="text" maxlength="50" value="{if isset($data)}{$data.parameter}{/if}" name="parameter" />
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-2 control-label">Value:</label>
        <div class="col-md-10">
    	       <input class="form-control" id="focusedInput" placeholder="Enter Parameter Value" type="text" maxlength="15" value="{if isset($data)}{$data.value}{/if}" name="value" />
        </div>
    </div>
